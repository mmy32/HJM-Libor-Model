...
def build_ou_diagnostics_figure(scores_df, ou_params, dt=1 / 252):
    ...
    for i, name in enumerate(factor_names):
        ...
        axes[i, 0].axhline(y=params["theta"], color="r", linestyle="--", label=f"theta = {params['theta']:.3f}")
        ...
        axes[i, 1].plot(x_range, theoretical_pdf, "r-", linewidth=2, label="Theoretical stationary dist.")
