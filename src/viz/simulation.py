...
def build_sample_paths_figure(result, n_factors, n_sample=5, plot_type="zero_rates", random_seed=None):
    ...
    ax.fill_between(
        time_grid, mean_10y - 2 * std_10y, mean_10y + 2 * std_10y, alpha=0.2, color="gray", label="+/-2 sigma"
    )
